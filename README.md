...
Current Version: `cmp ver 1.0.16`
...
sudo bash -lc "curl -fsSL https://raw.githubusercontent.com/koyan04/customer-management-portal/v1.0.16/scripts/bootstrap.sh | bash"
```
...
```bash
# Download and verify
curl -fsSL -o install.sh https://raw.githubusercontent.com/koyan04/customer-management-portal/v1.0.16/scripts/install.sh
...
```bash
sudo bash -lc "curl -fsSL https://raw.githubusercontent.com/koyan04/customer-management-portal/v1.0.16/scripts/install.sh | bash"
```
...
- Release: cmp ver 1.0.16 (current)
