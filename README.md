...
sudo bash -lc "curl -fsSL https://raw.githubusercontent.com/koyan-testpilot/customer-management-portal/v1.0.5/scripts/bootstrap.sh | bash"
```
...
```bash
sudo bash -lc "curl -fsSL https://raw.githubusercontent.com/koyan-testpilot/customer-management-portal/v1.0.5/scripts/install.sh | bash"
```
...
```bash
curl -fsSL -o install.sh https://raw.githubusercontent.com/koyan-testpilot/customer-management-portal/v1.0.5/scripts/install.sh
sha256sum install.sh
